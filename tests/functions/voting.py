...
from functions.voting import process_votes_csv, process_votes_csv_row, generate_annotated_csv_data
...
class TestFunctionsVoting(TestCase):
    def test_process_votes_csv(self):
        ...
        csv_rows = [
            ['Timestamp',           '',                      '', '', '', '', '', '', '', ''],
            ['4/1/2024 9:00:00',    'https://example.com/1', '', '', '', '', '', '', '', ''],
            ['12/31/2024 23:59:59', 'https://example.com/2', '', '', '', '', '', '', '', ''],
            ['02/02/2022 02:02:02', 'https://example.com/3', '', '', '', '', '', '', '', ''],
            ['11/6/2023 10:23:36',  'https://example.com/4', '', '', '', '', '', '', '', ''],
        ]
