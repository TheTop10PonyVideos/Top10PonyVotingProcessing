...
from functions.post_processing import create_post_processed_records, generate_archive_records, generate_sharable_records, generate_showcase_description
...
class TestFunctionsPostProcessing(TestCase):
    def test_create_post_processed_records(self):
        ...
        post_proc_records = create_post_processed_records(calc_records, videos_data, True)
    ...
    def test_generate_sharable_records(self):
        ...
        self.assertEqual('=VLOOKUP("https://example.com/4", IMPORTRANGE("https://docs.google.com/spreadsheets/d/1rEofPkliKppvttd8pEX8H6DtSljlfmQLdFR-SlyyX7E/edit", "top10!D:I"), 6, FALSE)', records[3]['Link'])
