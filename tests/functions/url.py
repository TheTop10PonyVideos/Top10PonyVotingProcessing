...
class TestFunctionsUrl(TestCase):
    ...
    def test_normalize_youtube_url(self):
        ...
        self.assertEqual(normalized_url, normalize_youtube_url('https://www.youtube.com/watch?v=Q8k4UTf8jiI'))
        self.assertEqual(normalized_url, normalize_youtube_url('https://www.youtube.com/live/Q8k4UTf8jiI'))
        self.assertEqual(normalized_url, normalize_youtube_url('https://youtu.be/Q8k4UTf8jiI'))
        self.assertEqual(normalized_url, normalize_youtube_url('https://www.youtube.com/watch?app=desktop&v=Q8k4UTf8jiI'))
