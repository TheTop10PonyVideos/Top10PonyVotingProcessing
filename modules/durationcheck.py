        ...
        for row in reader:
            ...
            for index, cell in enumerate(row):
                if 'youtube.com' in cell or 'youtu.be' in cell:
                    ...
                    if video_id:
                        title, privacy_state, uploader, duration = data_pulling.check_privacy_and_get_title(video_id)
                    ...
                    if 'pony.tube' in cell or 'vimeo.com' in cell or 'dailymotion.com' in cell:
                        ...
                        if video_link:
                            print(video_link)
                            title, uploader, duration = data_pulling.check_withYtDlp(video_link=video_link)
