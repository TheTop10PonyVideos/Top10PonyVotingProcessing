...
from functions.top_10_calc import process_shifted_voting_data, get_titles_to_urls_mapping, calc_ranked_records, load_top_10_master_archive, get_history
from functions.date import parse_votes_csv_timestamp, get_preceding_month_date, get_most_common_month_year
from functions.messages import suc, inf, err


# Path to the "shifted" version of the votes CSV. This file is generated by the
# vote-processing.py script. "Shifted" means that a blank column has been
# inserted after all of the original columns. We use this file in order to match
...
def handle_calc():
    ...
    voting_month, voting_year, is_unanimous = get_most_common_month_year(timestamp_dates)
