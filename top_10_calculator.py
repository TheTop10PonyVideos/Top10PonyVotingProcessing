...
input_file_entry = ttk.Entry(file_selectors_frame, width=40, textvariable=input_file_var)

browse_button = ttk.Button(
    file_selectors_frame, text="📁 Choose Input CSV...", command=browse_input_file
)
...
shifted_file_var = tk.StringVar()
shifted_file_var.set(default_shifted_file)
shifted_file_entry = ttk.Entry(file_selectors_frame, width=40, textvariable=shifted_file_var)

browse_button = ttk.Button(
    file_selectors_frame, text="📁 Choose Shifted Cells CSV...", command=browse_shifted_file
)
